...
// 前向声明MTCSerialContainer
namespace moveit_mtc_bt_nodes {
    class MTCSerialContainerNode;
}

namespace moveit_mtc_bt_nodes {

class MTCActionBaseNode : public BT::SyncActionNode {
public:
    MTCActionBaseNode(const std::string& name, const BT::NodeConfiguration& config,
